...
<head>
  ...
  <title>Testnet tXTM Faucet</title>
...
<body>
  <h1>Testnet tXTM Faucet</h1>
  <p>Enter a testnet Tari address below to receive a small amount of tXTM.</p>
  ...
  <form method="post" action="/request">
    ...
    <br>
    <button type="submit">Request tXTM</button>
  </form>
</body>
</html>
`))
